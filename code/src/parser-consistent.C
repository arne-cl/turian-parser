/*  $Id: parser-consistent.C 1657 2006-06-04 03:03:05Z turian $ 
 *  Copyright (c) 2004-2006, New York University. All rights reserved. */
/*!
 *  \file parser-consistent.C
 *  \brief Parse the treebank, only allowing the parser to consider
 *  decisions that are consistent with the gold-standard (treebank).
 *
 *
...
int main(int argc, char** argv) {
	...
	while(!treebank.is_done()) {
		...
		parser.consistently_parse_using_classifier();
